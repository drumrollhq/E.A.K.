...
eak.register-level-script '1-scrapyard/1.5-editing-text-ii.html' do
  ...
  tutorial: (tutorial) ->
    tutorial
      ...
      .lock!
      .step \1-first
        .say \1.1-first-off 'First off, this is the editor.'
        .say \1.2-save target: '#editor .save', focus: true,
          'You can press save when you\'re done...'
        .say \1.3-cancel target: '#editor .cancel', focus: true,
          'or \'cancel\' to return to the game - \'cancel\' will get rid of your changes though, so watch out!'
      .end \step

      .step \2-experiment
        .say \2.1-experiment 'One of the best ways to solve these things is to just experiment and try things out.'
        .say \2.2-matter 'It doesn\'t matter if you mess things up - '
        .say \2.3-reset target: '#editor .reset', focus: true,
          'just press \'reset\' to put the code back to how it started.'
      .end \step
      ...
      .target \press-help 'Ask for help' do
        wait: true
        condition: -> tutorial.help-requests >= 1

      .help!
        .step \4-too-long
          .unlock 'p::inner'
          .say \4-too-long 'These ledges are too long. Try deleting some of the black text to create a safe path into the cave.'
        .end \step
        .target \delete-text 'Make the ledges short enough to get into the cave.' do
          condition: -> $ 'p:nth-of-type(1)' .width! < 500
      .end \help
