countries = [[\gb 'United Kingdom'] [\us 'United States'] [\af 'Afghanistan'] [\ax 'Åland Islands']
  [\al 'Albania'] [\dz 'Algeria'] [\as 'American Samoa'] [\ad 'Andorra'] [\ao 'Angola'] [\ai 'Anguilla']
  ...
  [\ky 'Cayman Islands'] [\cf 'Central African Republic'] [\td 'Chad'] [\cl 'Chile'] [\cn 'China']
  ...
  [\tf 'French Southern Territories'] [\ga 'Gabon'] [\gm 'Gambia'] [\ge 'Georgia'] [\de 'Germany']
  ...
  [\na 'Namibia'] [\nr 'Nauru'] [\np 'Nepal'] [\nl 'Netherlands'] [\an 'Netherlands Antilles']
  [\nc 'New Caledonia'] [\nz 'New Zealand'] [\ni 'Nicaragua'] [\ne 'Niger'] [\ng 'Nigeria'] [\nu 'Niue']
  [\nf 'Norfolk Island'] [\mp 'Northern Mariana Islands'] [\no 'Norway'] [\om 'Oman'] [\pk 'Pakistan']
  ...
  [\tw 'Taiwan, Province of China'] [\tj 'Tajikistan'] [\tz 'Tanzania, United Republic of']
  [\th 'Thailand'] [\tl 'Timor-leste'] [\tg 'Togo'] [\tk 'Tokelau'] [\to 'Tonga'] [\tt 'Trinidad and Tobago']
  [\tn 'Tunisia'] [\tr 'Turkey'] [\tm 'Turkmenistan'] [\tc 'Turks and Caicos Islands'] [\tv 'Tuvalu']
...
options = countries.map ([id, name], i) -> dom.option value: id, key: i, name

module.exports = React.create-class {
  display-name: \CountrySelect

  prop-types: {
    country: React.PropTypes.string.is-required
  ...
  change: ->
    country = @refs.select.get-DOM-node!.value
    @set-state {country}
    @props.on-change country

  render: ->
    dom.select value: @state.country, on-change: @change, ref: \select, options
}
